...
function EnemyController(canvas){
	this.enemyArray = [];
	this.canvas = canvas;
	this.enemyControl = 0; //控制敌人数量
	//产生敌机
	this.produceEnemy = function(){
		this.enemyControl++;
		if(this.enemyControl ==30){
			this.enemyControl=0;
